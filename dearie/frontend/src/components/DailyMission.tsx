...
export default DailyMission   // ← 이 라인이 반드시 있어야 합니다

const styles = StyleSheet.create({
  container: { flexDirection: "row", alignItems: "center", borderWidth: 1, borderRadius: 12, padding: 16, backgroundColor: "#fff" },
  iconWrapper: { marginRight: 12, alignItems: "center", justifyContent: "center" },
  textWrapper: { flex: 1 },
  title: { fontSize: 16, fontWeight: "600", color: "#111827" },
  description: { marginTop: 4, fontSize: 14, color: theme.colors.gray[600] },
  difficulty: { marginTop: 6, fontSize: 12, color: theme.colors.gray[500] },
})
